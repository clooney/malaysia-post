...
Malaysia Post  tracking API and webhook make it easy to integrate Malaysia Post  Tracking function into your own project. Support APIs Client Libraries for PHP

### API key

In order to use this API, you need to generate a Malaysia Post  Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Malaysia Post  Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Malaysia Post  Tracking API](https://www.trackingmore.com/malaysia-post-tracking.html)  to:

   *   Get Malaysia Post  realtime tracking info of muti-carriers in one integration
   *   Provide Malaysia Post  shipment tracking experience like Amazon
   *   Push Malaysia Post   notifications of package update with webhook
   *   Verify Malaysia Post  delivery exception before it is too late
